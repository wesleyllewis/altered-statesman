...
module.exports = function() {
    ...
    //Direct url link to a specific show
    _helpers.showUrl = function(showSlug, options) {
        return ('/shows/' + showSlug)
    };

    //Direct url link to a specific album
    _helpers.albumUrl = function(albumSlug, options) {
        return ('/albums/' + albumSlug)
    };

    //Direct url link to a specific video
    _helpers.videoUrl = function(videoSlug, options) {
        return ('/videos/' + videoSlug)
    };
